# =============================================================================
# Title: Preprocessing of the GSE256335 Mouse Dataset
# Description:
#   This script prepares the mouse GSE256335 dataset for downstream
#   nested-test analysis.
#
#   Main steps:
#     - load the normalized event-level count table,
...
#
# Intended use:
#   Dataset-specific preprocessing for the mouse shutoff dataset (GSE256335).
#
...
# -----------------------------------------------------------------------------
# Set working directory for the GSE256335 dataset.
# -----------------------------------------------------------------------------
setwd("~/postexport-kinetics/real_datasets/GSE256335")

# Dataset: mouse with shutoff
require(data.table)
...
# -----------------------------------------------------------------------------
# Load the normalized event-level input table.
#
# An alternative raw count file is left commented for reference.
# -----------------------------------------------------------------------------
...
#   - replicate
#
# This is used to compute sample-level normalization factors.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Join the normalization factors back to the main table and compute normalized
# counts at the replicate/sample level.
# -----------------------------------------------------------------------------
...
#   - model state
#
# The current script sums raw counts rather than count_norm.
# -----------------------------------------------------------------------------
